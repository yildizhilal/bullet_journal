...
import Hedef2 from '../components/Hedef2';
...
const Hedefler = () => {
  ...
  const [Gun, setGun] = useState("bos");
  
  const [KalanGun, setKalanGun] = useState("bos");
...
renderList = (list) => {
  ...
  createAliskanlik = () => {
    ...
    Firebase.firestore().collection("Users").doc("Hedefler").collection("Hedefler").doc(isim).set({
      name: isim,
      color:color,
      icon:iconn,
      gun:Gun,
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      backgroundColor="orange" 
        ...
        centerComponent={{ text: 'Hedefler', style: { color: '#fff',fontSize:25} }}
      />
          <View style={{ flex:1,justifyContent: "center", alignItems: "center" }}>
            ...
            />
              ...
              <View style={{ alignSelf: "stretch", marginHorizonal: 32 }}>
                <Text style={styles.title}>Hedef Ekle</Text>
